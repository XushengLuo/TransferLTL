...
# end2path = multi_trees(h_task_lib, buchi_graph, ts, no, centers, 500)
...
subtask2path, starting2waypoint, todo, todo_succ, newsubtask2subtask_p = detect_reuse(h_task_lib, h_task_new, end2path)
start4 = datetime.datetime.now()
end2path = transfer_multi_trees(buchi_graph, (init_pos, buchi_graph.graph['init'][0]), todo_succ, ts, no, centers,
                                3000, subtask2path, starting2waypoint, newsubtask2subtask_p)
